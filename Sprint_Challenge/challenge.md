...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  - First, catching potential bugs or un-handled edge cases is important.
  After that, I would value feedback on readability and maintainability.
  Someone new to the code should be able to easily understand what the code is
  doing and, optimally, see why the code is doing it in the way that it does.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
  - Containers provides a reusable, identical baseline for everyone to work from,
  no matter the configuration of their individual computer. This enables us to
  have a reproducible environment to run our code with.
